...
//M    a    n : 부모클래스, 슈퍼클래스, 상위클래스
//BusinessMan : 자식클래스, 서브클래스, 하위클래스
//              [ 상속 사용 이용 ]
// 코드의 재활용(초보자들이 상속을 이해하는 개념)
// 연관성이 없는 다 수의 클래스에 연관성을 부여하여
...
class BusinessMan extends Man{ // exteds : 없어도 쓸수잇댜
    String company;

    public BusinessMan(){
        super(); // 암묵적으로 여기에 숨겨져있는 super!!!
